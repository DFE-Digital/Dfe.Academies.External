...
internal sealed class ReferenceDataRetrievalServiceTests
{
	...
	public async Task GetTrustsByPagination___ApiReturns200___Success()
	{
		...
		// act
		var referenceDataRetrievalService = new ReferenceDataRetrievalService(mockFactory.Object, mockLogger.Object);
		var trustsByPagination = await referenceDataRetrievalService.GetTrustsByPagination(trustSearch);
	...
	public async Task GetTrustsByPagination___ApiReturns500___Failure()
	{
		...
		// assert
		var ex = Assert.ThrowsAsync<HttpRequestException>(() => referenceDataRetrievalService.GetTrustsByPagination(trustSearch));
	}
