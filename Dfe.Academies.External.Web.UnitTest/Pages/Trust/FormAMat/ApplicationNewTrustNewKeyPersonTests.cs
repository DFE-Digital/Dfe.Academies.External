...
internal sealed class ApplicationNewTrustNewKeyPersonTests
{
	...
	public async Task OnGetAsync___Valid___NullErrors()
	{
		...
		// act
		var pageModel = SetupApplicationNewTrustKeyPersonModel(mockConversionApplicationRetrievalService.Object,
	...
	private static ApplicationNewTrustKeyPersonModel SetupApplicationNewTrustKeyPersonModel(
		...
		bool isAuthenticated = false)
	{
		...
		return new ApplicationNewTrustKeyPersonModel(mockConversionApplicationRetrievalService, mockReferenceDataRetrievalService,
