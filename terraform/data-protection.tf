module "data_protection" {
  source = "github.com/DFE-Digital/terraform-azurerm-aspnet-data-protection?ref=v1.0.2"

  data_protection_key_vault_assign_role           = true
  ...
  data_protection_container_identity_principal_id = module.azure_container_apps_hosting.container_app_managed_identity.principal_id
}
