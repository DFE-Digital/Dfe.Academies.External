class SchoolImprovementStrategyDetails {
  public fillSchoolImprovementStrategyAndSubmit(): this {
...
const schoolImprovementStrategyDetails = new SchoolImprovementStrategyDetails()

export default schoolImprovementStrategyDetails
