...
describe('Change Trust Name From JAM App Overview Page', () => {
    ...
    it('should be able to change the name of the trust from JAM App Overview Page - (School Previously Added)', () => {
        ...
        // SELECT CHANGE TRUST FROM APP OVERVIEW PAGE
        A2BYourApplication.selectChangeTrust()

        // CHECK ELEMENTS ON WHICHTRUSTISTHESCHOOLJOINING PAGE
        Header.govUkHeaderVisible()
        Header.applyToBecomeAnAcademyHeaderLinkVisible()
        ...
        //CHANGE THE NAME OF THE TRUST AND SUBMIT THE FORM
        A2BWhichTrustIsSchoolJoining.changeTrustName()
